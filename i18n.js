...
const ORD = {
    ...
    btnStart:       { da: "▶ Start ur",          en: "▶ Start timer" },
    btnResume:      { da: "▶ Fortsæt ur",        en: "▶ Resume timer" },
    btnPause:       { da: "⏸ Pause ur",          en: "⏸ Pause timer" },
    btnSaveNap:     { da: "Gem lur",             en: "Save nap" },
    btnReset:       { da: "Nulstil",             en: "Reset" },
    timerHelp:      { da: "Uret kan bruges helt uden lyd. Afspiller du en lyd, starter det af sig selv.", en: "The timer works with no sound at all. Playing a sound starts it automatically." },
    resetConfirm:   { da: "Vil du nulstille uret uden at gemme?", en: "Reset the timer without saving?" },
    timerZero:      { da: "Søvnuret er på nul. Tryk 'Start ur' eller afspil en lyd først.", en: "The timer is at zero. Press 'Start timer' or play a sound first." },
